...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 17, 2023 at 02:17 AM
...
--
ALTER TABLE `pasien`
  MODIFY `idPasien` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1235;
COMMIT;
